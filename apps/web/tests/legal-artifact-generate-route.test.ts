...
function buildSubmission() {
  return {
    ...
    patientAdditionalWhatsapps: ["(11) 98888-1111"],
    ...
    contactAdditionalWhatsapps: ["(11) 97777-2222"],
    contactCpf: "222.333.444-55",
    contactRg: "SP-7.654.321",
    processRepresentativeFullName: "Dra. Laura Demo",
    processRepresentativeCpf: "444.555.666-77",
    processRepresentativeRg: "MG-8.765.432",
    processRepresentativeAddress: "Rua C, 789",
    processRepresentativeWhatsapp: "(11) 96666-0000",
    processRepresentativeEmail: "laura.demo@example.com",
    processRepresentativeAdditionalEmails: ["laura.alt@example.com"],
    processRepresentativeAdditionalWhatsapps: ["(11) 95555-2222"],
