...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const submission = {
      ...
      contactIsProcessRepresentative: submissionRecord.contactIsProcessRepresentative ?? true,
      ...
      processRepresentativeFullName: submissionRecord.processRepresentativeFullName ?? "",
      processRepresentativeCpf: submissionRecord.processRepresentativeCpf ?? "",
      processRepresentativeRg: submissionRecord.processRepresentativeRg ?? "",
      processRepresentativeAddress: submissionRecord.processRepresentativeAddress ?? "",
      processRepresentativeWhatsapp: submissionRecord.processRepresentativeWhatsapp ?? "",
      processRepresentativeEmail: submissionRecord.processRepresentativeEmail ?? "",
      processRepresentativeAdditionalEmails:
        submissionRecord.processRepresentativeAdditionalEmails ?? [],
      processRepresentativeAdditionalWhatsapps:
        submissionRecord.processRepresentativeAdditionalWhatsapps ?? [],
