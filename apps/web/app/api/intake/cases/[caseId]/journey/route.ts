import { CaseRepository, JourneyTimelineRepository } from "@safetycare/database";
...
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const journey = await journeyTimelines.findByCaseId(caseId);
