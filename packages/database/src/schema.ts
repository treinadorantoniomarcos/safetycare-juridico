...
export const legalBriefInputsTable = pgTable(
  "legal_brief_inputs",
  {
    ...
    patientAdditionalEmails: jsonb("patient_additional_emails").$type<string[]>().notNull().default([]),
    ...
    contactAdditionalEmails: jsonb("contact_additional_emails").$type<string[]>().notNull().default([]),
