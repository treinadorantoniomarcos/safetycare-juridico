...
function formatLegalBriefInput(record: LegalBriefInputRecord): CivilHealthBriefInput {
  return {
    ...
    patientAdditionalEmails: record.patientAdditionalEmails ?? [],
    patientAdditionalWhatsapps: record.patientAdditionalWhatsapps ?? [],
    ...
    contactAdditionalEmails: record.contactAdditionalEmails ?? [],
    contactAdditionalWhatsapps: record.contactAdditionalWhatsapps ?? [],
    ...
    processRepresentativeAdditionalEmails: record.processRepresentativeAdditionalEmails ?? [],
