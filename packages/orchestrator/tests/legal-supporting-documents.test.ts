...
describe("buildCivilHealthSupportingDocumentPack", () => {
  it("builds the procuração and contract templates", () => {
    const pack = buildCivilHealthSupportingDocumentPack({
      ...
      patientAdditionalEmails: ["paciente.alt@example.com"],
      patientAdditionalWhatsapps: ["(41) 98888-0000"],
      patientRg: "9876543",
      ...
      contactAdditionalEmails: ["responsavel.alt@example.com"],
      contactAdditionalWhatsapps: ["(41) 97777-0000"],
      contactCpf: "22233344455",
      contactRg: "1234567",
      processRepresentativeFullName: "Advogada Exemplo",
      processRepresentativeCpf: "44455566677",
      processRepresentativeRg: "RG-REP-01",
      processRepresentativeAddress: "Rua D, 321, Curitiba-PR",
      processRepresentativeWhatsapp: "(41) 97777-3333",
      processRepresentativeEmail: "advogada@example.com",
      processRepresentativeAdditionalEmails: ["advogada.alt@example.com"],
      processRepresentativeAdditionalWhatsapps: ["(41) 96666-3333"],
